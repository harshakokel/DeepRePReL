...
import torch
import argparse
from examples.taxi.taxi_planner import TaxiTRLPlanner
import os
...
def experiment(variant):
    ...
    eval_path_collector = TRLPathCollector(eval_env, operator_qfs,
                                           policy=ArgmaxDiscretePolicy,
                                           planner=eval_planner,
                                           task_terminal_reward=0)
    expl_path_collector = TRLPathCollector(expl_env, operator_qfs, strategy=exploration_strategy,
                                           policy=ArgmaxDiscretePolicy, planner=expl_planner,
